...
class eachLetter :
    ...
    # Go trough every letter, and look if they match, return True back when match is found
    ...
    # Go trough every letter, and look if they match, set Return_value to true and return after running trough every letter
...
class eachWord :
    ...
    # Run test and print out time taken for running the tests
    def runTest(self) :
        n = 10 # time how long n action's take
        benchmark = timeit.Timer(self.search_slow)
        print ("Search-slow :", benchmark.timeit(n), "seconds to go trough " + str(n) + " times")
